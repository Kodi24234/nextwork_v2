...
<nav
    class="md:hidden fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 flex justify-around items-center h-16 shadow-lg z-30">
    ...
    <a href="{{ route('profile.show') }}"
        class="flex flex-col items-center justify-center text-xs p-2
          {{ request()->routeIs('profile.show') ? 'bg-blue-50 text-blue-600 font-semibold' : 'text-gray-700 hover:bg-gray-100' }}">
